...
"C:\Program Files (x86)\Microsoft SDKs\Windows\v10.0A\bin\NETFX 4.6.1 Tools\xsd" "/outputdir: %~dp0\Classes" "/c" "%~dp0\Schema\entityclasses.xsd"
...
"C:\Program Files (x86)\Microsoft SDKs\Windows\v10.0A\bin\NETFX 4.6.1 Tools\xsd" "/outputdir: %~dp0\Classes" "/c" "%~dp0\Schema\entitygroups.xsd"
...
"C:\Program Files (x86)\Microsoft SDKs\Windows\v10.0A\bin\NETFX 4.6.1 Tools\xsd" "/outputdir: %~dp0\Classes" "/c" "%~dp0\Schema\spawning.xsd"
...
"C:\Program Files (x86)\Microsoft SDKs\Windows\v10.0A\bin\NETFX 4.6.1 Tools\xsd" "/outputdir: %~dp0\Classes" "/c" "%~dp0\Schema\gamestages.xsd"
pause